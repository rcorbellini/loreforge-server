...
_WHY_BY_REGRA = {
    ...
    # FR-002/R2, famílias POSSE e LUGAR: prometer TER algo, ou CHEGAR a algum
    # lugar, sem dizer o quê nem onde. A frase cobre as duas porque a falta é a
    # mesma — o critério aponta para nada.
    "intencao_posse_sem_alvo": ("diga O QUÊ, ou não há como saber que aconteceu — "
                                "a coisa que há de estar com você, o lugar onde "
                                "há de chegar"),
